...
public class HelloServiceServiceLocator extends org.apache.axis.client.Service implements tryout.web.webservice.axis2.helloaxis.HelloServiceService {
    ...
    private java.lang.String HelloService_address = "http://localhost:8080/Tryout.Web.Webservice.Axis2.HelloAxis2.001/services/HelloService";
    ...
    public tryout.web.webservice.axis2.helloaxis.HelloService getHelloService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            tryout.web.webservice.axis2.helloaxis.HelloServiceSoapBindingStub _stub = new tryout.web.webservice.axis2.helloaxis.HelloServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (tryout.web.webservice.axis2.helloaxis.HelloService.class.isAssignableFrom(serviceEndpointInterface)) {
                tryout.web.webservice.axis2.helloaxis.HelloServiceSoapBindingStub _stub = new tryout.web.webservice.axis2.helloaxis.HelloServiceSoapBindingStub(new java.net.URL(HelloService_address), this);
                _stub.setPortName(getHelloServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://helloaxis.axis2.webservice.web.tryout", "HelloServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://helloaxis.axis2.webservice.web.tryout", "HelloService"));
        }
